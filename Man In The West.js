...
// To do that, he passes a bucket through the river's soil
// and then checks if it contains any gold. However, he could be more productive if he wrote an algorithm to do the job for him.
//
